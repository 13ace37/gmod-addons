...
CreateConVar("ttt_no_nade_throw", "0")
CreateConVar("ttt_instant_nade", "1")
...
function SWEP:PrimaryAttack()
    ...
    if GetConVar("ttt_no_nade_throw"):GetBool() then
        return
    end
...
function SWEP:PullPin()
    ...
    if GetConVar("ttt_instant_nade"):GetBool() then
        self:SetDetTime(CurTime())
    else
